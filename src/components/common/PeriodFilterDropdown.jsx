...
export default function PeriodFilterDropdown({
  ...
  return (
    <div className={`relative inline-block text-left ${isOpen ? 'z-[9999]' : 'z-30'}`} ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-72 sm:w-80 rounded-2xl bg-[#0c111c] border border-amber-500/50 shadow-[0_20px_50px_rgba(0,0,0,0.9)] z-[99999] overflow-hidden animate-scale-in ring-2 ring-amber-500/20">
